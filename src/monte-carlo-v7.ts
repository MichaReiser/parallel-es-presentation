...
function createGroups(requiredAmount: number, noInterestReference: number, simulation: IMonteCarloSimulation): IGroup[] {
    return [
        { description: "Ziel erreichbar", from: requiredAmount, name: "green", percentage: 0, separator: true},
        { description: "mit Zusatzliquidität erreichbar", from: requiredAmount - simulation.liquidity, name: "yellow", percentage: 0, separator: true, to: requiredAmount },
        { description: "nicht erreichbar", from: noInterestReference, name: "gray", percentage: 0, separator: false, to: requiredAmount - simulation.liquidity },
        { description: "nicht erreichbar, mit Verlust", name: "red", percentage: 0, separator: false, to: noInterestReference }
    ];
}

function calculateRequiredAmount(project: IProject, simulation: IMonteCarloSimulation) {
...
function calculateProject(project: IProject, simulation: IMonteCarloSimulation): IProjectResult {
    ...
    const groups = createGroups(requiredAmount, simulation.noInterestReferenceLine[project.startYear], simulation);
